...
MAX_ITEMS_IN_MP_QUEUE = 3 # Number of items that can be queued until results are forcibly popped.
    ...
    try:
        ...
        while True:
            ...
            if camera_feed is not None:
                ...
                queues.object_detection_queue.put(model.track(
                    camera_feed, persist=True
                )[0])
...
class Camera:
    ...
    def load_default_model(self, cross_process_queues):
        ...
        Arguments:
            cross_process_queues -- the queues responsible for managing messages
                                    and results across camera <-> yolo processes.
        """
        global queues
